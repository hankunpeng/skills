    ...
    def validate(self):
        ...
        try:
            with zipfile.ZipFile(self.original_docx, "r") as zip_ref:
                original_xml_bytes = zip_ref.read("word/document.xml")
        except KeyError:
            print(
                f"FAILED - Original word/document.xml not found in {self.original_docx}"
            )
            return False
        except Exception as e:
            print(f"FAILED - Error reading original docx: {e}")
            return False
