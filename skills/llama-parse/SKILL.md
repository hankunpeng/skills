...
- **Low Credits Warning**: If the remaining Free Plan credits fall below 100, the script will output a prominent `[WARNING] LlamaParse remaining credits are below 100!` message to alert the user of impending exhaustion.
