...
options:
  - label: "User (Recommended)"
    description: "$HOME/.config/skills/translate/EXTEND.md (all projects)"
  - label: "Project"
    description: ".config/skills/translate/EXTEND.md (this project only)"
```
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `$HOME/.config/skills/translate/EXTEND.md` | All projects |
| Project | `.config/skills/translate/EXTEND.md` | Current project |
