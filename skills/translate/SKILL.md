...
metadata:
  openclaw:
    homepage: https://github.com/hankunpeng/skills#translate
    requires:
      anyBins:
        - bun
        - npx
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.config/skills/translate/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/skills/translate/EXTEND.md` | User home |
